...
<head>
	...
	<link href="{{asset('public/asset/css/fullcalendar.print.css')}}" rel='stylesheet'>
	...
	<!-- The fav icon -->
	<link rel="shortcut icon" href="imgaes/favicon.jpg">
					...
					<div class="alert alert-info">
						...
						<fieldset>
							...
							<button type="submit" class="btn btn-primary">Login</button>
                                ...
                                <a href="welcome/user_registration" class="btn btn-primary">New? Register Here</a>
							</p>
						</fieldset>
					</form>
				</div><!--/span-->
